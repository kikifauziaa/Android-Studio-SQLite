...
public class MainActivity extends AppCompatActivity implements
	...
	NoteFragment.OnNoteFragmentListener, RegisterFragment.OnRegisterFragmentListener {
	...
	public void onRegisterButtonClicked(View view, String username, String password) {
		...
		Snackbar.make(view, "Registration has been successfull", Snackbar.LENGTH_SHORT).show();
